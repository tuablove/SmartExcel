...
public class GradeFeeReadDto implements Serializable {
    ...
    public GradeFeeReadDto() {
    }

    public GradeFeeReadDto(Integer number, String name, String description, BigDecimal income, BigDecimal outcome, Long ticketNum, String comment, Date createDate) {
        this.number = number;
        this.name = name;
