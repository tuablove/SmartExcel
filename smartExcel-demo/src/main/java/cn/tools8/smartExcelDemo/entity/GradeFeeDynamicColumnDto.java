...
//    @ExcelExport(names = {"学费统计报表","学费统计报表","学费统计报表"})
    ...
    public GradeFeeDynamicColumnDto() {
    }

    public GradeFeeDynamicColumnDto(Integer number, String name, String description, BigDecimal income, BigDecimal outcome, Long ticketNum, String comment, Date createDate) {
        this.number = number;
        this.name = name;
